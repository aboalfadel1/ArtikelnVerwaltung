 ...
 */
final class Version20250203135920 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD slug VARCHAR(255) NOT NULL, ADD body LONGTEXT NOT NULL, ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL, ADD favorited TINYINT(1) NOT NULL, ADD favorites_count INT NOT NULL, CHANGE content description LONGTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD content LONGTEXT NOT NULL, DROP slug, DROP description, DROP body, DROP created_at, DROP updated_at, DROP favorited, DROP favorites_count');
    }
}
